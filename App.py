...
CATEGORIAS = {
    ...
    "2. Estructura y contenido de la tabla nutricional": [
        ...
        ("Formato, tipografía y jerarquía visual de la tabla nutricional",
         "Verificar que la tabla de información nutricional emplee tipografía Arial o Helvetica, en color negro sobre fondo contrastante, sin cursivas ni estilos decorativos. El tamaño de letra debe ser ≥ 8 pt para envases con área de la cara principal hasta 100 cm² y proporcionalmente mayor para envases de mayor tamaño. El título debe declararse como “Información Nutricional”, “Datos de Nutrición” o “Información Nutrimental”, en tipografía Arial o Helvetica con un tamaño mínimo de 10 pt. Los nombres de calorías, grasa saturada, grasas trans, azúcares añadidos y sodio deben presentarse en negrilla y con un tamaño de letra al menos 1,3 veces mayor que el del resto de los nutrientes. La tabla debe conservar márgenes, proporciones y estructura, sin incluir imágenes, logotipos ni elementos gráficos dentro del recuadro.",
